...
const ReportSchema = z.object({
    ...
    category:      z.enum(
        ['SPAM', 'FAKE_PROFILE', 'INAPPROPRIATE_CONTENT', 'HARASSMENT', 'OTHER'] as const,
        { error: 'Invalid category. Allowed: SPAM, FAKE_PROFILE, INAPPROPRIATE_CONTENT, HARASSMENT, OTHER.' }
    ),
